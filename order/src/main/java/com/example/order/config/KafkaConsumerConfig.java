...
public class KafkaConsumerConfig {
    ...
    public static final String PAYMENT_CONFIRMED_EVENT_CONSUMER_GROUP_ID = "payment-confirmed-event-consumer";
    public static final String PAYMENT_FAILED_EVENT_CONSUMER_GROUP_ID = "payment-failed-event-consumer";
